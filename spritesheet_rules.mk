...
$(OBJEVENTGFXDIR)/people/may/snow_drift.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4
...
$(FLDEFFGFXDIR)/ground_impact_dust_snow.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 1
...
$(OBJEVENTGFXDIR)/people/lass_hgss.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/people/breeder_f_hgss.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
