...
{
    // SAMPLE TRAINER_CLASS
    // TRAINER_CLASS(CLASS_NAME, "STRINGNAME", [Money#], ITEM_[BALLTYPE]_BALL, [SwitchChance%])
    // ie., TRAINER_CLASS(PKMN_TRAINER_1, "{PKMN} TRAINER", 10, ITEM_POKE_BALL, 40)
