...
const u8 gText_EVO_FRIENDSHIP[]                     = _("High friendship LvlUp");
const u8 gText_EVO_FRIENDSHIP_DAY[]                 = _("High friendship LvlUp, day");
const u8 gText_EVO_FRIENDSHIP_NIGHT[]               = _("High friendship LvlUp, night");
...
const u8 gText_EVO_FRIENDSHIP_MOVE_TYPE[]           = _("High friendship LvlUp, {STR_VAR_2} move");
