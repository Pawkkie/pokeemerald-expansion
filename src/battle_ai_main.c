...
void ScorePartyMons(enum BattlerId battler, enum BattlerId opposingBattler, struct Pokemon *party, struct Pokemon *opposingParty, u32 firstId, u32 lastId, u32 opposingFirstId, u32 opposingLastId)
{
