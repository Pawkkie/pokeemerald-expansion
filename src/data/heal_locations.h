static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_RESEARCH_OUTPOST - 1] = {MAP_GROUP(RESEARCH_OUTPOST), MAP_NUM(RESEARCH_OUTPOST), 16, 20},
    [HEAL_LOCATION_SVEALUND - 1] = {MAP_GROUP(SVEALUND), MAP_NUM(SVEALUND), 10, 10},
};
