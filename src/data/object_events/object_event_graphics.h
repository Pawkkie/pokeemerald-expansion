...
const u32 gObjectEventPic_MaySnowDrift[] = INCBIN_U32("graphics/object_events/pics/people/may/snow_drift.4bpp");
...
const u32 gFieldEffectObjectPic_GroundImpactDustSnow[] = INCBIN_U32("graphics/field_effects/pics/ground_impact_dust_snow.4bpp");
const u32 gFieldEffectObjectPic_JumpTallGrass[] = INCBIN_U32("graphics/field_effects/pics/jump_tall_grass.4bpp");
const u32 gFieldEffectObjectPic_JumpSnowTallGrass[] = INCBIN_U32("graphics/field_effects/pics/jump_tall_grass.4bpp"); // Swap for jump_snow_tall_grass.4bpp if decide to use a unique sprite
...
const u32 gFieldEffectObjectPic_SnowDrift[] = INCBIN_U32("graphics/field_effects/pics/snow_drift.4bpp");
