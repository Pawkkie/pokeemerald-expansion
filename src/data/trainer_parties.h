...
static const struct TrainerMon sParty_Nancy[] = {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_ZIPPY_ZAP, MOVE_EXTREME_SPEED, MOVE_IRON_TAIL, MOVE_KNOCK_OFF},
    },
    {
    ...
    .moves = {MOVE_AURORA_VEIL, MOVE_BLIZZARD, MOVE_MOONBLAST, MOVE_DISABLE},
    },
    {
    ...
    .nature = NATURE_JOLLY,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_NIGHT_SLASH, MOVE_TRIPLE_AXEL, MOVE_ICE_SHARD, MOVE_FAKE_OUT},
    },
    {
    ...
    .nature = NATURE_BOLD,
    .iv = TRAINER_PARTY_IVS(31, 0, 31, 31, 31, 31),
    .moves = {MOVE_FOUL_PLAY, MOVE_SNARL, MOVE_HELPING_HAND, MOVE_THUNDER_WAVE},
    },
};
