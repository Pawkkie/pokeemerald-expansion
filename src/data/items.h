...
// Poké Balls
    ...
    [ITEM_FRIEND_BALL] =
    {
        .name = _("Friend Ball"),
        .price = 1000,
        .description = COMPOUND_STRING("A Ball that maxes\n"
                                        "caught Pokémon's\n"
                                        "friendship."),
        .pocket = POCKET_POKE_BALLS,
        .type = ITEM_USE_BAG_MENU,
    ...
    [ITEM_DREAM_BALL] =
    {
        .name = _("Dream Ball"),
        .price = 1000,
        .description = COMPOUND_STRING("Caught Pokémon will\n"
                                        "have their Hidden\n"
                                        "Ability."),
        .pocket = POCKET_POKE_BALLS,
        .type = ITEM_USE_BAG_MENU,
...
// Vitamins
    ...
    [ITEM_HP_UP] =
    {
        .name = _("HP Up"),
        .price = 10000,
        .description = COMPOUND_STRING("Raises the HP IV\n"
                                        "of one Pokémon\n"
                                        "by 10."),
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_PARTY_MENU,
...
// Misc. Held Items
    ...
    [ITEM_EXP_SHARE] =
    {
        ...
        .price = 0,
        .importance = 1,
        .description = COMPOUND_STRING("Turning this on\n"
                                        "gives all in party\n"
                                        "EXP. points."),
        .pocket = POCKET_KEY_ITEMS,
        .type = ITEM_USE_FIELD,
    ...
    [ITEM_CLEANSE_TAG] =
    {
        ...
        .price = 0,
        .importance = 1,
        .description = COMPOUND_STRING("When turned on,\n"
                                        "repels lower level\n"
                                        "wild Pokémon."),
        .pocket = POCKET_KEY_ITEMS,
        .type = ITEM_USE_FIELD,
...
// Misc. Key Items
    ...
    [ITEM_ACRO_BIKE] =
    {
        .name = _("Bike"),
        .price = 0,
        .description = COMPOUND_STRING("Can jump, wheelie,\n"
                                        "or speed up slopes.\n"
                                        "R to switch modes."),
        .importance = 1,
        .pocket = POCKET_KEY_ITEMS,
...
// Story Key Items
    ...
    [ITEM_TAXI_TICKET] =
    {
        ...
        .price = 0,
        .importance = 1,
        .description = COMPOUND_STRING("Calls a flying\n"
                                        "Pokémon from the\n"
                                        "taxi service."),
        .pocket = POCKET_KEY_ITEMS,
        .type = ITEM_USE_BAG_MENU,
    ...
    [ITEM_LANTERN] =
    {
        ...
        .price = 0,
        .importance = 1,
        .description = COMPOUND_STRING("A bright lantern\n"
                                        "that can light dark\n"
                                        "caves."),
        .pocket = POCKET_KEY_ITEMS,
        .type = ITEM_USE_FIELD,
    ...
    [ITEM_POKEVIAL] =
    {
        ...
        .price = 0,
        .importance = 1,
        .description = COMPOUND_STRING("Full of snacks\n"
    ...
    [ITEM_CANDY_JAR] =
    {
        ...
        .price = 0,
        .importance = 1,
        .description = COMPOUND_STRING("A bottomless\n"
                                        "jar filled with\n"
                                        "Rare Candies."),
        .pocket = POCKET_KEY_ITEMS,
        .type = ITEM_USE_PARTY_MENU,
    ...
    [ITEM_TRAINING_BAND] =
    {
        ...
        .description = COMPOUND_STRING("Massively boosts\n"
                                        "Exp. gain for\n"
                                        "weaker Pokémon."),
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_BAG_MENU,
    ...
    [ITEM_TYPE_CHART] =
    {
        .name = _("Type Chart"),
        .price = 0,
        .description = COMPOUND_STRING("A chart showing\n"
                                        "Pokémon type\n"
                                        "matchups."),
        .importance = 1,
        .pocket = POCKET_KEY_ITEMS,
    ...
    [ITEM_COND_CHECKER] =
    {
        .name = _("Cond. Checker"),
        .price = 0,
        .description = COMPOUND_STRING("Check your\n"
                                        "Pokémon's condition\n"
                                        "for contests."),
        .importance = 1,
        .pocket = POCKET_KEY_ITEMS,
    ...
    [ITEM_AXE] =
    {
        ...
        .price = 0,
        .importance = 1,
        .description = COMPOUND_STRING("Can be used to\n"
                                        "cut down small\n"
                                        "trees."),
        .pocket = POCKET_KEY_ITEMS,
        .type = ITEM_USE_FIELD,
    ...
    [ITEM_WAILMER_SNACK] =
    {
        ...
        .price = 0,
        .importance = 1,
        .description = COMPOUND_STRING("Toss into water\n"
                                        "to summon and ride\n"
                                        "a friendly Wailmer."),
        .pocket = POCKET_KEY_ITEMS,
        .type = ITEM_USE_FIELD,
    ...
    [ITEM_SCUBA_GEAR] =
    {
        ...
        .price = 0,
        .importance = 1,
        .description = COMPOUND_STRING("Allows you to ride\n"
                                        "a friendly Wailmer\n"
                                        "underwater."),
        .pocket = POCKET_KEY_ITEMS,
        .type = ITEM_USE_FIELD,
    ...
    [ITEM_ABILITY_CHANGER] =
    {
        ...
        .price = 0,
        .holdEffectParam = 0,
        .description = COMPOUND_STRING("Miracle meds that\n"
                                        "change a Pokémon's\n"
                                        "ability."),
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_PARTY_MENU,
