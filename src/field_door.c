...
static const u8 sDoorAnimTiles_LabDoorBottom[] = INCBIN_U8("graphics/door_anims/lab_bottom.4bpp");
static const u16 sDoorNullPalette50[16] = {};
static const u8 sDoorAnimTiles_LabDoorTop[] = INCBIN_U8("graphics/door_anims/lab_top.4bpp");
...
static const u8 sDoorAnimPalettes_LabDoorBottom[] = {8, 8, 8, 8, 8, 8, 8, 8};
static const u8 sDoorAnimPalettes_LabDoorTop[] = {8, 8, 8, 8, 8, 8, 8, 8};
...
static const struct DoorGraphics sDoorAnimGraphicsTable[] =
{
    ...
    {METATILE_PetalburgLeoBSnow_LabDoorBottom,              DOOR_SOUND_NORMAL,  DOOR_SIZE_1x1, sDoorAnimTiles_LabDoorBottom, sDoorAnimPalettes_LabDoorBottom},
    {METATILE_PetalburgLeoBSnow_LabDoorTop,                 DOOR_SOUND_NORMAL,  DOOR_SIZE_1x1, sDoorAnimTiles_LabDoorTop, sDoorAnimPalettes_LabDoorTop},
    {},
};
